...
SELECT name FROM people WHERE name = 'Luis Tejero';
name     
-------------
Luis Tejero
(1 row)
...
UPDATE people SET name = 'Jeff 4' WHERE id = 23;
...
UPDATE movies SET show_time = 21:30 WHERE tittle = 'Guardians of the Galaxy';
